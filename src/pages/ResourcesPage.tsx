...
const resourcesData: Resource[] = [
  {
    ...
    description: 'A curated selection of practice exam questions and answers to help you prepare for the AWS Certified Cloud Practitioner exam.',
    type: 'pdf',
    fileUrl: 'https://drive.google.com/file/d/1rt_lyOHoHIbnGRiHJoU4zXvwfNvCmsa-/view',
    meta: '2.4 MB',
  ...
  },
  {
    ...
    description: 'Part two of our comprehensive exam prep series, featuring more mock questions and clear explanations of core AWS concepts.',
    type: 'pdf',
    fileUrl: 'https://drive.google.com/file/d/15a71OqogbJ1bU-4u04uuH0dbbFbhg6FX/view',
    meta: '1.8 MB',
  ...
  },
  {
    ...
    description: 'An introductory handbook covering the core principles, services, and architecture guidelines of Amazon Web Services.',
    type: 'pdf',
    fileUrl: 'https://drive.google.com/file/d/1Yhnff_VJEJXUP72ftTr_5Ug1f3sa3tur/view',
    meta: '3.2 MB',
  ...
  },
  {
    ...
    description: 'Deep dive into Amazon Web Services, detailing service limits, deployment options, and management console features.',
    type: 'pdf',
    fileUrl: 'https://drive.google.com/file/d/1naFIN2L12vGdP2D3gXlfKDYrgEP7nVSg/view',
    meta: '4.1 MB',
  ...
  },
  {
    ...
    description: 'Advanced AWS configuration details, focusing on database services, migration guidelines, and network configurations.',
    type: 'pdf',
    fileUrl: 'https://drive.google.com/file/d/1diTvGFbDapyZqluUl3RVSeGoHo3d0LJE/view',
    meta: '3.7 MB',
  ...
  },
  {
    ...
    description: 'Additional target review questions focusing on security and compliance domains for the CLF-C02 practitioner exam.',
    type: 'pdf',
    fileUrl: 'https://drive.google.com/file/d/1X49gb03ouK-nyxciuiG2j7oMh4SMc4wj/view',
    meta: '1.5 MB',
  ...
  },
  {
    ...
    description: 'Official slides, session notes, and follow-up materials from the AWS Student Builders Group Bootcamp.',
    type: 'pdf',
    fileUrl: 'https://drive.google.com/file/d/1ExSONQpBsbJy7WQzomFySzYtlal4uluJ/view',
    meta: '5.4 MB',
  ...
  },
  {
    ...
    description: 'Detailed curriculum and lab guide for the AWS Cloud Immersion Program, designed for hands-on builders.',
    type: 'pdf',
    fileUrl: 'https://drive.google.com/file/d/1HWaYlX4_HDBxUXecAPpwvn8FTUr8AEKN/view',
    meta: '6.8 MB',
  ...
  },
  {
    ...
    description: 'The official exam guide outlining domains, weightings, and key topics for the Certified Cloud Practitioner exam.',
    type: 'pdf',
    fileUrl: 'https://drive.google.com/file/d/1YBgUFtmW7Q8e66hGUxewtMGQfimDdKpj/view',
    meta: '1.2 MB',
  ...
  },
  {
    ...
    description: 'Student-compiled study notes summarizing all key AWS services, computing models, and architectural best practices.',
    type: 'pdf',
    fileUrl: 'https://drive.google.com/file/d/1FsZRbPlye2lEYfqhwB8m13HKZ8RV0Y34/view',
    meta: '2.8 MB',
  ...
  },
  {
    ...
    description: 'A comprehensive bank of actual practice test questions to simulate the exam environment and test your readiness.',
    type: 'pdf',
    fileUrl: 'https://drive.google.com/file/d/1sknsYCu-YYJzjLVk7nz6bC0lcpoiy4Ao/view',
    meta: '4.5 MB',
  ...
  {
    id: 'study-repo',
    title: 'AWS CERTIFIED CLOUD PRACTITIONER CLF-C02 | Student Study Resource Repository',
    description: 'A rich collection of student-led study notes, diagrams, and summary cheat sheets for exam success.',
    type: 'pdf',
    fileUrl: 'https://drive.google.com/file/d/1AMJXu9-6YPHj0SX3ylR26OLzt_pDEAjL/view',
    meta: '8.2 MB',
  ...
  {
    id: 'lite-exams',
    title: 'AWS Certified Cloud Practitioner CLF-C02 Lite Edition • 3 Full-Length Exams',
    description: 'Three full-length, high-quality practice exams designed to assess your speed, accuracy, and knowledge.',
    type: 'pdf',
    fileUrl: 'https://drive.google.com/file/d/1oJzEwjS7BekhF_I017LWnM9bWqIyWLae/view',
    meta: '3.9 MB',
  ...
  },
  {
    ...
    description: 'Presentation slides and resource links from our practitioner essentials seminar.',
    type: 'pdf',
    fileUrl: 'https://drive.google.com/file/d/14blAXX64D0-j1ncg6_ERY7146JSCgKkt/view',
    meta: '2.1 MB',
...
const ResourcesPage = () => {
  ...
  const handleDownload = (fileUrl: string, _filename: string, e: React.MouseEvent) => {
    e.preventDefault();
    e.stopPropagation();
  ...
  return (
    <div className="font-alexandria min-h-screen bg-white text-[#272F3A] overflow-x-hidden flex flex-col justify-between">
      ...
      >
        ...
        >
          <span className="w-4 h-4 rounded-full bg-[#9747FF] flex items-center justify-center text-white text-[9px]">📁</span>
          Resources Hub
        </motion.div>
        ...
        >
          Download high-quality audio and PDF resources curated to help
          you build, scale and succeed with AWS.
        </motion.p>
          ...
          <div className="relative">
            ...
            <AnimatePresence>
              {isDropdownOpen && (
                ...
                >
                  {['All Categories', 'Exam Prep', 'Reference', 'Bootcamp', 'Immersion', 'Study Notes', 'Seminar'].map((cat) => (
                    <button
                      key={cat}
                      onClick={() => {
      ...
      <main className="w-[95%] lg:w-[90%] max-w-7xl mx-auto px-4 sm:px-6 lg:px-0 py-10 flex-grow">
          ...
          <div className="bg-[#FFFFFF] border border-gray-100 rounded-full p-1.5 shadow-[0_4px_15px_rgba(0,0,0,0.03)] flex gap-1 sm:gap-2">
            {[
              ...
              return (
                <button
                  key={tab.id}
                  onClick={() => setActiveTab(tab.id as 'all' | 'audio' | 'pdf')}
                ...
                >
                  ...
                  <span className={isSelected ? 'text-white font-semibold' : 'text-[#414D60]'}>
                    {tab.label}
                  </span>
                </button>
              );
        ...
        <div className="flex justify-between items-center mb-8 border-b border-gray-100 pb-4">
          <div>
            <h2 className="text-xl sm:text-2xl font-bold text-[#002B6B]">Featured Resources</h2>
          </div>
          <button 
            onClick={() => { setSearchQuery(''); setActiveTab('all'); setSelectedCategory('All Categories'); }}
                  ...
                  <div>
                    ...
                    <div className="flex justify-between items-center w-full">
                      <div className={`p-2.5 rounded-xl flex items-center justify-center ${
                        isAudio ? 'bg-[#F3E8FF] text-[#9747FF]' : 'bg-[#FFF0F3] text-[#FF4D6D]'
                      }`}>
                        {isAudio ? <FiVolume2 className="w-5 h-5" /> : <FiFileText className="w-5 h-5" />}
                      </div>
                      <span className={`text-[10px] sm:text-xs font-semibold px-2.5 py-1 rounded-full ${
                        isAudio ? 'bg-[#F3E8FF]/60 text-[#9747FF]' : 'bg-[#FFF0F3]/60 text-[#FF4D6D]'
                      }`}>
                        {resource.category}
                      </span>
                    </div>
                    ...
                    <div className="flex gap-2">
                      {isAudio ? (
                        <>
                          ...
                          <button
                            onClick={(e) => handleDownload(resource.fileUrl, `${resource.title}.mp3`, e)}
                        ...
                        <button
                          onClick={(e) => handleDownload(resource.fileUrl, `${resource.title}.pdf`, e)}
          ...
          {filteredResources.length === 0 && (
            <div className="col-span-full py-16 flex flex-col items-center justify-center text-center">
              <div className="w-16 h-16 rounded-full bg-gray-50 flex items-center justify-center text-gray-400 mb-4 border border-gray-100">
                {activeTab === 'audio' ? <FiVolume2 className="w-6 h-6 text-[#9747FF]" /> : <FiSearch className="w-6 h-6" />}
              </div>
              <h4 className="text-[#002B6B] font-bold text-lg mb-1">
                {activeTab === 'audio' ? 'Check back later' : 'No resources found'}
              </h4>
        ...
        <section className="mt-20">
          <div className="w-full bg-[#F3E8FF]/70 border border-[#D0B6F2]/30 rounded-3xl p-6 md:p-10 flex flex-col lg:flex-row items-center justify-between gap-6 md:gap-8 shadow-[0_8px_30px_rgba(151,71,255,0.03)] relative overflow-hidden">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-5 md:gap-6 w-full lg:w-auto relative z-10 text-center sm:text-left">
              ...
              <div>
                <h3 className="text-lg md:text-xl font-bold text-[#002B6B]">Stay Updated with New Resources</h3>
                <p className="text-gray-600 text-xs md:text-sm font-manrope mt-1">
                  Subscribe to get notified when new audio or PDF resources are added.
                </p>
              </div>
            </div>
                ...
                {!isSubscribed ? (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-xs text-[#0F5132]/80 mt-0.5">Thank you! You will be notified of new resources.</p>
                    </div>
                  </motion.div>
                )}
              </AnimatePresence>
