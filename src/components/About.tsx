...
const AboutSection = () => {
  return (
    <motion.section className='bg-[#FFFFFF] lg:my-[5rem] my-[3rem] lg:mx-[6.4rem] mx-[2rem] font-alexandria text-center items-center gap-[2.8rem]'>
      {/* Title */}
      <motion.h1
      ...
      {/* Mission + Vision */}
      <motion.article className='w-full justify-between flex flex-row flex-wrap items-center lg:gap-0 gap-[2rem]'>
        {/* Mission Card */}
        <motion.div
      ...
      {/* Intro Section */}
      <motion.article className='flex lg:flex-row flex-col justify-between lg:py-[2.8rem] text-[#1E242C] text-start items-start gap-[1.1875rem]'>
        <motion.h2
      ...
      <motion.article className='lg:flex hidden flex-row flex-wrap justify-between lg:gap-0 gap-[2.43rem]'>
        <motion.img
          initial={{ opacity: 0, y: 50 }}
          whileInView={{ opacity: 1, y: 0 }}
