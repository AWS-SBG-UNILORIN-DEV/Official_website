...
const CommunitySection = () => {
  return (
    ...
    >
      ...
      <article className="bg-[url('/Images/community/bg.svg')] bg-cover bg-center min-h-screen lg:h-screen w-full lg:flex hidden items-center justify-center gap-[3.5rem] relative ">
